...
* [Timeplus Proton](https://github.com/timeplus-io/proton) - A streaming SQL engine, a fast and lightweight alternative to Apache Flink, 🚀 powered by ClickHouse. [Apache-2.0] [website](https://timeplus.com)
